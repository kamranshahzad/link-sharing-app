...
<?php
	...
	$form = new MuxForm('userSavePostFrm');
                        ...
                        <div class="profile-tab-content">
                            ...
                            <div class="user-end-form">
                                <div class="form-field-row">
                                    <span class="form-label">Link:*<span class="field-description">Valid url of post</span></span>
                                    <input type="text" class="text-field" name="linktxt" id="linktxt" />
                                </div>
                                <div class="form-field-row">
