...
<?php
	...
	$sortFilter = 'recent';
	if(isset($_GET['sort'])){
		if(array_key_exists($_GET['sort'], Block::$sortGameOptionsArr)){
            ...
            <div class="heading-container">
                ...
                <div class="sort-wrapper">
                    <div id="sort-container">
                        <?=Block::drawGameSorter('games.php',$sortFilter);?>
                    </div>
                </div>
                <div class="clear"></div>
           </div>
            
			<?=$mapObj->drawGamesGrid($boot, $sortFilter);?>
            <br />
            <?=$mapObj->drawPaginig($boot);?>
            <br /><br />
