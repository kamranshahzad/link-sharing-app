...
?>
<title>Siz-el : Random Links</title>
<?=$boot->drawCss();?>
		   ...
		   <div class="heading-container">
					...
					<div class="sort-wrapper">
						<div id="sort-container">
							<?=Block::drawArchiveSorter('random-links.php',$sortFilter);?>
						</div>
					</div>
					<div class="clear"></div>
		    </div>
            ...
            <?php
				...
				echo($mapObj->drawArchivePostsGrid($boot , $sortFilter ));
				echo('<br/>');
