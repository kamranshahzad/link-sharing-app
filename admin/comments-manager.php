<?php
	...
	$routeOptions = array('view'=>array('show'=>'CommentsView'),'form'=>array('modify'=>'showCommentsFrm'));
...
<div class="wrapper">
    ...
    <div class="nav-bar">
        ...
        <?=$boot->drawBreadcrumb( array('add'=>'Create New Topic','modify'=>'Modify User Comment') )?>
        <br />          
