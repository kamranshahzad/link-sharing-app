<?php
	...
	$routeOptions = array('view'=>array('show'=>'AdsView'),'form'=>array('googleads'=>'GoogleAdsFrm','topad'=>'TopAdsFrm','bottomad'=>'BottomBarAdsFrm'));
...
<div class="wrapper">
    ...
    <div class="header">
    	<div class="logo">
        <img src="<?=$imgsPath?>logo.jpg" width="170" height="125" alt="" /></div>
   	  	<div class="top-ad">
        </div>
    </div>
    ...
    <div class="nav-bar">
        ...
        <?=$boot->drawBreadcrumb( array( 'googleads'=>'Google Ads' , 'topad'=>'Top Ads' , 'rightad'=>'Right Bar Ads') )?>
        <br />          
