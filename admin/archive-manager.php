<?php
	...
	$routeOptions = array('view'=>array('show'=>'topicsView'),'form'=>array('add'=>'TopicFrm','modify'=>'TopicFrm'));
...
<div class="wrapper">
    ...
    <div class="nav-bar">
        ...
        <?=$boot->drawBreadcrumb( array('add'=>'Create New Topic','modify'=>'Modify Topic') )?>
        <br />          
