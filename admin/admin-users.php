<?php
	...
	$routeOptions = array('view'=>array('show'=>'adminUsersView'),'form'=>array('add'=>'adminUserFrm','modify'=>'adminUserFrm'));
...
<div class="wrapper">
    ...
    <div class="nav-bar">
        ...
        <?=$boot->drawBreadcrumb( array('add'=>'Create New User','modify'=>'Modify User') )?>
        <br />          
