...
?>
<title>Siz-el : User Comments</title>
<?=$boot->drawCss();?>
    ...
    <div class="contentWrapper">
        ...
        <div class="profile-container">
            ...
            <div class="left-content-container">
                ...
                <?php echo Block::drawUserBlock();?>
                
                <br />
                <div class="user-profile-tab">
                    	<div class="profile-tab-header">
                            <ul>
                                <li id="selected"><a href="user-posts-comments.php">Post Comments</a></li>
                                <li><a href="user-games-comments.php">Game Comments</a></li>
                                <li><a href="user-poll-comments.php">Poll Comments</a></li>
                            </ul>
                        </div>
                        <div class="profile-tab-content">
                        	<?php
								$mapObj = new PostCommentsMapper();
								echo $mapObj->drawUserPostComments($boot);
								unset($mapObj);
							?>
