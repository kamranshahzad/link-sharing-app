...
<?php
	...
	$connectArr = $mapObj->drawConnects($UID);	
?>
<title>Siz-el : User Connections</title>
<?=$boot->drawCss();?>
    ...
    <div class="contentWrapper">
       ...
       <div class="user-settings-container">
       		<div class="profile-tab-header">
                <?=Block::drawUserSettingTabs('connections');?>
            </div>
            <div class="profile-tab-content">
                
                <div class="user-connections-form">
                	<div class="option-row">
                    	<img src="<?=$assetLoc;?>facebook-connect.jpg" width="116" height="32" />
                        <div class="connect-container">
                        	<a href="facebook_<?=$UID;?>" id="facebook_<?=$UID;?>"><?=$connectArr['facebook']?></a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="option-row">
                    	<img src="<?=$assetLoc;?>google-connect.jpg" width="116" height="32" />
                        <div class="connect-container">
                        	<a href="google_<?=$UID;?>" id="google_<?=$UID;?>"><?=$connectArr['google']?></a>
                        </div>
                        <div class="clear"></div>
                    </div>
                </div><!--@user-connections-form-->
