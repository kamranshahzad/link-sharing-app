            ...
            <div class="left-content-container">
                ...
                <div class="user-profile-tab">
                    	<div class="profile-tab-header">
                            <ul>
                                <li><a href="user-posts-comments.php">Post Comments</a></li>
                                <li><a href="user-games-comments.php">Game Comments</a></li>
                                <li id="selected"><a href="user-poll-comments.php">Poll Comments</a></li>
                            </ul>
                        </div>
                        <div class="profile-tab-content">
                        	<?php
                            	$mapObj = new PollCommentsMapper();
								echo $mapObj->drawUserPollComments($boot);
								unset($mapObj);
							?>
