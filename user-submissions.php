            ...
            <div class="left-content-container">
                ...
                <div class="user-profile-tab">
                    	<div class="profile-tab-header">
                            <ul>
                                <li id="selected"><a href="user-submissions.php">List Posts</a></li>
                                <li><a href="user-submissions-save-step1.php">Create New Post</a></li>
                            </ul>
                        </div>
                        <div class="profile-tab-content">
                        	<?php
                            	$mapObj = new PostsMapper();
								echo $mapObj->drawUserPosts($boot);
								unset($mapObj)
							?>
