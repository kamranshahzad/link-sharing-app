...
?>
<title>Siz-el : User Followers</title>
<?=$boot->drawCss();?>
            ...
            <div class="left-content-container">
                ...
                <div class="user-profile-tab">
                    	<div class="profile-tab-header">
                            <ul>
                                <li id="selected"><a href="user-followers.php">Followers</a></li>
                                <li><a href="user-following.php">Following</a></li>
                            </ul>
                        </div>
                        <div class="profile-tab-content">
                        	<?php
                            	$mapObj = new UserMapper();
								echo($mapObj->drawMyFollowers($boot));
								unset($mapObj);
							?>
