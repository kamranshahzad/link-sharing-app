...
<?php
	...
	$topicTitle = ArrayUtil::value('topic_title',$tmapObj->fetchById($topicId));
	unset($tmapObj);
...
?>
<title>Siz-el : Archive Posts</title>
<?=$boot->drawCss();?>
    ...
    <div class="contentWrapper">
       ...
       <div class="left-content-container">
           ...
           <div class="heading-container">
					<h1>Archive: (<?=$topicTitle;?>)</h1>
					<div class="sort-wrapper">
						<div id="sort-container">
							<?=Block::drawArchiveByTopicSorter($sortFilter);?>
						</div>
					</div>
					<div class="clear"></div>
		    </div>
            ...
            <?php
				...
				echo($mapObj->drawArchivePostsByTopicsGrid($boot , $sortFilter , $topicId ));
				echo('<br/>');
