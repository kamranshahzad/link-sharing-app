            ...
            <div class="left-content-container">
                ...
                <div class="user-profile-tab">
                    	<div class="profile-tab-header">
							<?=Block::drawUserActivityTabs('comment',$uid);?>
                        </div>
                        <div class="profile-tab-content">
                        	<?php
								echo '<div class="seachfoundLine" style="color:#969696 !important;">Post Comments</div>';
								$ptmapObj = new PostCommentsMapper();
								echo $ptmapObj->drawActivitiesUserPostComments($boot, $uid);
								unset($ptmapObj);
								
								echo '<div class="seachfoundLine" style="color:#969696 !important;">Poll Comments</div>';
								$plmapObj = new PollCommentsMapper();
								echo $plmapObj->drawActivitesUserPollComments($boot , $uid);
								unset($plmapObj);
								
								echo '<div class="seachfoundLine" style="color:#969696 !important;">Game Comments</div>';
								$gmmapObj = new GameCommentsMapper();
								echo $gmmapObj->drawActivitesUserGameComments($boot, $uid);
								unset($gmmapObj);
							?>
