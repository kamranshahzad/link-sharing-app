...
?>
<title>Siz-el : Search Users</title>
<?=$boot->drawCss();?>
            ...
            <div class="extend-search-tab">
                    	<div class="search-tab-header">
                            <ul>
                                ...
                                <li><a href="search-games.php?<?=$currentSearchStrings?>">Games</a></li>
                                <li id="selected"><a href="search-users.php?<?=$currentSearchStrings?>">Users</a></li>
                            </ul>
                        </div>
                        <div class="search-tab-content">
                        	...
                        	<?php
								...
								echo $mapObj->drawUserSearchGrd($boot,$currentParams);
								unset($mapObj);
							?>
