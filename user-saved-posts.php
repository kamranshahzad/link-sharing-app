...
?>
<title>Siz-el : User Saved Posts</title>
<?=$boot->drawCss();?>
            ...
            <div class="left-content-container">
                ...
                <div class="user-profile-tab">
                    	<div class="profile-tab-header">
                            <ul>
                                <li id="selected"><a href="user-saved-posts.php">Saved Posts</a></li>
                                <li><a href="user-saved-polls.php">Saved Polls</a></li>
                        ...
                        <div class="profile-tab-content">
                        	<?php
								...
								echo $mapObj->loadUserSavePosts($boot);
							?>
